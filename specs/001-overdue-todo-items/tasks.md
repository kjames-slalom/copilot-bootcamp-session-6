...
- [ ] T001 Review current todo state/render flow in packages/frontend/src/App.js
- [ ] T002 [P] Create shared overdue test fixtures in packages/frontend/src/__tests__/fixtures/overdueTodos.js
- [ ] T003 [P] Create deterministic local-date test helper in packages/frontend/src/__tests__/helpers/dateTestHelper.js
...
- [ ] T004 Create overdue utility module scaffold in packages/frontend/src/utils/overdueUtils.js
- [ ] T005 Create overdue utility test scaffold in packages/frontend/src/utils/__tests__/overdueUtils.test.js
- [ ] T006 Create overdue integration test scaffold in packages/frontend/src/__tests__/App.test.js
- [ ] T007 Create overdue component test scaffold in packages/frontend/src/components/__tests__/TodoCard.test.js
...
- [ ] T008 [P] [US1] Add failing unit tests for overdue rule and two-group sorting in packages/frontend/src/utils/__tests__/overdueUtils.test.js
- [ ] T009 [P] [US1] Add failing component test for overdue badge/class rendering in packages/frontend/src/components/__tests__/TodoCard.test.js
- [ ] T010 [P] [US1] Add failing integration test for overdue-first and newest-first ordering in packages/frontend/src/__tests__/App.test.js

### Implementation for User Story 1

- [ ] T011 [US1] Implement isOverdue and sortByOverdue in packages/frontend/src/utils/overdueUtils.js
- [ ] T012 [US1] Apply sortByOverdue before list rendering in packages/frontend/src/App.js
- [ ] T013 [US1] Render overdue badge and overdue class for overdue todos in packages/frontend/src/components/TodoCard.js
- [ ] T014 [US1] Add overdue visual styles using danger token in packages/frontend/src/App.css
...
- [ ] T015 [US2] Add failing integration tests for edit/toggle overdue transitions in packages/frontend/src/__tests__/App.test.js

### Implementation for User Story 2

- [ ] T016 [US2] Update edit/toggle state update paths to preserve overdue regrouping in packages/frontend/src/App.js
- [ ] T017 [US2] Ensure overdue indicator reflects post-edit/post-toggle todo state in packages/frontend/src/components/TodoCard.js
...
- [ ] T018 [P] [US3] Add failing integration test for fetch-on-load overdue ordering in packages/frontend/src/__tests__/App.test.js
- [ ] T019 [P] [US3] Add failing regression test that completed todos never show overdue badge in packages/frontend/src/components/__tests__/TodoCard.test.js

### Implementation for User Story 3

- [ ] T020 [US3] Ensure fetchTodos render path uses overdue sort pipeline after reload in packages/frontend/src/App.js
- [ ] T021 [US3] Harden invalid/missing dueDate handling for reload scenarios in packages/frontend/src/utils/overdueUtils.js
...
- [ ] T022 [P] Update manual acceptance steps to match implementation in specs/001-overdue-todo-items/quickstart.md
- [ ] T023 Run frontend tests and capture execution notes in specs/001-overdue-todo-items/quickstart.md
- [ ] T024 [P] Confirm no backend/API contract change note in specs/001-overdue-todo-items/research.md
- [ ] T025 [P] Refresh overdue accessibility wording in docs/ui-guidelines.md
